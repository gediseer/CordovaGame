...
(function () {
    ...
    var j = "linkScreen", p = "12px Arial", s = 240, t = 320, w = [], E = [], A = "", D = 1, ha = !1, x = 1, f = {
        ...
        }, da = [], ea = {up: 38, down: 40, left: 37, right: 39, a: 90, b: 88, c: 67, menu: 49, quit: 50}, z = {
            menu: 0,
            run: 1,
            stop: 2,
            over: 3,
...
(function (g) {
    ...
    var B = ["s2"], C = [[[230, 142, 34, 24], [230, 194, 34, 24], [230, 246, 34, 24], [230, 298, 34, 24], [230, 350, 34, 24], [174, 466, 34, 24], [118, 466, 34, 24], [62, 466, 34, 24], [6, 466, 34, 24]]], b = [{
        aR: [-15, -30, 30, 30],
        bR: [-16, -15, 32, 31],
        fA: [[0, 5, -16, -11, 0]]
